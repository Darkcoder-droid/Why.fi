...
**UI hint:** yes
Success criteria:
1. The webpage feels like a meme control room.
2. The webcam feed remains the central element but with a themed frame.
...
**UI hint:** yes
Success criteria:
1. The final results screen displays captured evidence and average scores in a theatrical way.
2. The transition from gameplay to results is smooth and impactful.
3. Typography and layered backgrounds are consistent throughout the experience.
